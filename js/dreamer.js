$(window).scroll(function () {
    ...
    if (scrollTop > $('.info_section__logo').offset().top - $(window).height() / 1.5) {
        $('.info_section__logo').addClass('active');
        $('.logo_design').addClass('active');
    } else {
        $('.info_section__logo').removeClass('active');
        $('.logo_design').removeClass('active');
    }
